    ...
    <main className="min-h-screen bg-slate-950">
      <div className="grid min-h-screen lg:grid-cols-2">
        ...
        >
          ...
          <div className="relative flex w-full flex-col justify-center p-12">
            ...
            <p className="mt-6 max-w-xl text-lg text-slate-300">
              Customs Operations, Freight Forwarding, Shipment Tracking, CRM, Invoice Management, Trade Intelligence and Document Repository from one enterprise platform.
            </p>
            ...
            <div className="mt-10 rounded-2xl border border-cyan-500/20 bg-cyan-500/5 p-5">
              ...
              >
                Explore Public Intelligence Portal →
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center p-8">
          <div className="w-full max-w-lg rounded-3xl border border-cyan-500/20 bg-slate-900 p-10 shadow-2xl">

            <div className="mb-8">
              <p className="text-sm font-bold uppercase tracking-[0.25em] text-amber-400">
                MarineTraffic Group Product
              </p>
            ...
            >
              ...
              <div className="mt-8 grid grid-cols-2 gap-3 text-center">
                <div className="rounded-xl border border-slate-800 bg-slate-950 p-3">
                  <div className="text-lg font-black text-cyan-400">12,500+</div>
                  <div className="text-xs text-slate-400">Shipments</div>
                </div>

                <div className="rounded-xl border border-slate-800 bg-slate-950 p-3">
                  <div className="text-lg font-black text-cyan-400">1,000+</div>
                  <div className="text-xs text-slate-400">Clients</div>
                </div>

                <div className="rounded-xl border border-slate-800 bg-slate-950 p-3">
                  <div className="text-lg font-black text-cyan-400">180+</div>
                  <div className="text-xs text-slate-400">Trade Routes</div>
                </div>

                <div className="rounded-xl border border-slate-800 bg-slate-950 p-3">
                  <div className="text-lg font-black text-cyan-400">42+</div>
